      ...
      <RX.View useSafeInsets={true}>
        <RX.ScrollView style={styles.scroll}>
          <RX.View style={styles.container}>
            ...
            <RX.Text style={styles.welcome}>Welcome to ReactXP</RX.Text>
            ...
            >
              <RX.Text style={styles.buttonText}>See More Examples</RX.Text>
            </RX.Button>

            <RX.Button style={styles.roundButton} onPress={this._onPressLogin}>
              <RX.Text style={styles.buttonText}>Login</RX.Text>
            </RX.Button>
          </RX.View>
        </RX.ScrollView>
      </RX.View>
