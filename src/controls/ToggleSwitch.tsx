...
> {
  ...
  constructor(props: ToggleSwitchProps) {
    ...
    this._knobLeftAnimationValue = RX.Animated.createValue(
      props.value ? KNOB_LEFT_ON : KNOB_LEFT_OFF
    );
    ...
    this._toggleColorAnimationValue = RX.Animated.createValue(
      props.value ? 1 : 0
    );
  ...
  render() {
    const backgroundStyle = [
      _styles.toggleSwitchBackground,
      this._toggleColorAnimationStyle
    ];
